...
class ContextBuilder:
    ...
    def __init__(self, filesystem_manager: Any) -> None:
        ...
        self.dir_structure_cache: Dict[str, Tuple[str, float]] = (
            {}
        )  # 키: 경로, 값: (구조, 타임스탬프)
        self.cache_ttl: int = 300  # 5분 캐시 유효 시간

    def get_file_context(
        self, file_path: str, detail_level: str = "basic"
    ) -> Dict[str, Any]:
        """
    ...
    def format_move_prompt(
        self, file_context: Dict[str, Any], dir_structure: str
    ) -> str:
        """
